...
- [BatchStatementUpdate.java](file://lealone-common/src/main/java/com/lealone/server/protocol/batch/BatchStatementUpdate.java)
...
**协议类型体系概览**
- [PacketType.java](file://lealone-common/src/main/java/com/lealone/server/protocol/PacketType.java#L10-L55)
...
**图示来源**
- [SessionInit.java](file://lealone-common/src/main/java/com/lealone/server/protocol/session/SessionInit.java#L20-L108)
...
**本节来源**
- [SessionInit.java](file://lealone-common/src/main/java/com/lealone/server/protocol/session/SessionInit.java#L12-L33)
- [SessionPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/SessionPacketHandlers.java#L20-L22)
...
**图示来源**
- [StatementQuery.java](file://lealone-common/src/main/java/com/lealone/server/protocol/statement/StatementQuery.java#L16-L23)
- [StatementPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/StatementPacketHandlers.java#L17-L18)

**本节来源**
- [StatementQuery.java](file://lealone-common/src/main/java/com/lealone/server/protocol/statement/StatementQuery.java#L16-L60)
...
**图示来源**
- [ResultFetchRows.java](file://lealone-common/src/main/java/com/lealone/server/protocol/result/ResultFetchRows.java#L16-L24)
- [ResultPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/ResultPacketHandlers.java#L28-L33)

**本节来源**
- [ResultFetchRows.java](file://lealone-common/src/main/java/com/lealone/server/protocol/result/ResultFetchRows.java#L16-L50)
- [ResultPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/ResultPacketHandlers.java#L21-L26)
...
**本节来源**
- [BatchStatementUpdate.java](file://lealone-common/src/main/java/com/lealone/server/protocol/batch/BatchStatementUpdate.java#L18-L26)
- [BatchStatementPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/BatchStatementPacketHandlers.java#L29-L31)
...
**本节来源**
- [LobRead.java](file://lealone-common/src/main/java/com/lealone/server/protocol/lob/LobRead.java#L16-L28)
- [LobPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/LobPacketHandlers.java#L30-L31)
...
**本节来源**
- [PacketType.java](file://lealone-common/src/main/java/com/lealone/server/protocol/PacketType.java#L8-L10)
- [SessionInit.java](file://lealone-common/src/main/java/com/lealone/server/protocol/session/SessionInit.java#L68-L74)
...
**图示来源**
- [SessionInit.java](file://lealone-common/src/main/java/com/lealone/server/protocol/session/SessionInit.java#L12)
- [StatementQuery.java](file://lealone-common/src/main/java/com/lealone/server/protocol/statement/StatementQuery.java#L30)
- [ResultFetchRows.java](file://lealone-common/src/main/java/com/lealone/server/protocol/result/ResultFetchRows.java#L28)
- [ResultClose.java](file://lealone-common/src/main/java/com/lealone/server/protocol/result/ResultClose.java#L28)
- [SessionClose.java](file://lealone-common/src/main/java/com/lealone/server/protocol/session/SessionClose.java#L28)
