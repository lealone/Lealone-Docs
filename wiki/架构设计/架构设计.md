...
- [InternalScheduler.java](file://lealone-sci/src/main/java/com/lealone/db/scheduler/InternalScheduler.java)
...
**图示来源**  
- [lealone-db](file://lealone-db)
- [lealone-sci](file://lealone-sci)
- [lealone-aose](file://lealone-aose)
- [lealone-aote](file://lealone-aote)
- [lealone-sql](file://lealone-sql)
- [lealone-server](file://lealone-server)

**本节来源**  
- [lealone-main](file://lealone-main)
- [lealone-client](file://lealone-client)
...
**图示来源**  
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L153-L203)
- [Database.java](file://lealone-db/src/main/java/com/lealone/db/Database.java#L207-L238)
...
**图示来源**  
- [PluggableEngine.java](file://lealone-sci/src/main/java/com/lealone/db/plugin/PluggableEngine.java#L16-L45)
- [StorageEngine.java](file://lealone-sci/src/main/java/com/lealone/storage/StorageEngine.java#L14-L24)
- [TransactionEngine.java](file://lealone-sci/src/main/java/com/lealone/transaction/TransactionEngine.java#L17-L71)
- [SQLEngine.java](file://lealone-sci/src/main/java/com/lealone/sql/SQLEngine.java#L15-L34)
- [ProtocolServerEngine.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngine.java#L13-L20)
...
**图示来源**  
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L123-L203)
- [Database.java](file://lealone-db/src/main/java/com/lealone/db/Database.java#L207-L238)

**本节来源**  
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L48-L203)
...
**图示来源**  
- [EmbeddedScheduler.java](file://lealone-sci/src/main/java/com/lealone/db/scheduler/EmbeddedScheduler.java#L64-L76)
- [InternalScheduler.java](file://lealone-sci/src/main/java/com/lealone/db/scheduler/InternalScheduler.java#L14-L47)
...
**本节来源**  
- [EmbeddedScheduler.java](file://lealone-sci/src/main/java/com/lealone/db/scheduler/EmbeddedScheduler.java#L277-L296)
...
**本节来源**  
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L203-L206)
- [Database.java](file://lealone-db/src/main/java/com/lealone/db/Database.java#L532-L533)
