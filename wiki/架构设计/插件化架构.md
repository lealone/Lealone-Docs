...
- [PluginManager.java](file://lealone-common/src/main/java/com/lealone/db/plugin/PluginManager.java)
- [Plugin.java](file://lealone-common/src/main/java/com/lealone/db/plugin/Plugin.java)
- [PluginBase.java](file://lealone-common/src/main/java/com/lealone/db/plugin/PluginBase.java)
- [PluginObject.java](file://lealone-db/src/main/java/com/lealone/db/plugin/PluginObject.java)
- [CreatePlugin.java](file://lealone-sql/src/main/java/com/lealone/sql/admin/CreatePlugin.java)
- [StartPlugin.java](file://lealone-sql/src/main/java/com/lealone/sql/admin/StartPlugin.java)
- [StartServer.java](file://lealone-sql/src/main/java/com/lealone/sql/admin/StartServer.java)
...
- [ProtocolServerEngine.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngine.java)
- [ProtocolServerEngineBase.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngineBase.java)
...
- [Config.java](file://lealone-main/src/main/java/com/lealone/main/config/Config.java#L1-L185)
- [PluggableEngine.java](file://lealone-sci/src/main/java/com/lealone/db/plugin/PluggableEngine.java#L1-L46)
- [PluginManager.java](file://lealone-common/src/main/java/com/lealone/db/plugin/PluginManager.java#L1-L124)
- [Plugin.java](file://lealone-common/src/main/java/com/lealone/db/plugin/Plugin.java#L1-L39)
- [PluginBase.java](file://lealone-common/src/main/java/com/lealone/db/plugin/PluginBase.java#L1-L101)
- [PluginObject.java](file://lealone-db/src/main/java/com/lealone/db/plugin/PluginObject.java#L1-L102)
- [SQLEngine.java](file://lealone-sci/src/main/java/com/lealone/sql/SQLEngine.java#L1-L33)
- [SQLEngineBase.java](file://lealone-sql/src/main/java/com/lealone/sql/SQLEngineBase.java#L1-L59)
- [LealoneSQLEngine.java](file://lealone-sql/src/main/java/com/lealone/sql/LealoneSQLEngine.java#L1-L26)
- [ProtocolServerEngine.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngine.java#L1-L19)
- [ProtocolServerEngineBase.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngineBase.java#L1-L58)
- [AOStorageEngine.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/AOStorageEngine.java#L1-L32)
- [AOStorageBuilder.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/AOStorageBuilder.java#L1-L41)
- [AOStorage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/AOStorage.java#L1-L40)
- [AOTransactionEngine.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransactionEngine.java#L1-L36)
- [AOTransaction.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransaction.java#L168-L198)
...
图表来源
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L153-L207)
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L253-L318)
- [Config.java](file://lealone-main/src/main/java/com/lealone/main/config/Config.java#L1-L185)
- [PluggableEngine.java](file://lealone-sci/src/main/java/com/lealone/db/plugin/PluggableEngine.java#L1-L46)
- [PluginManager.java](file://lealone-common/src/main/java/com/lealone/db/plugin/PluginManager.java#L1-L124)
...
图表来源
- [CreatePlugin.java](file://lealone-sql/src/main/java/com/lealone/sql/admin/CreatePlugin.java#L1-L115)
- [StartPlugin.java](file://lealone-sql/src/main/java/com/lealone/sql/admin/StartPlugin.java#L1-L46)
- [PluginObject.java](file://lealone-db/src/main/java/com/lealone/db/plugin/PluginObject.java#L1-L102)
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L318-L329)
...
图表来源
- [Lealone.java](file://lealone-main/src/main/java/com/lealone/main/Lealone.java#L253-L318)
- [Config.java](file://lealone-main/src/main/java/com/lealone/main/config/Config.java#L115-L185)
- [PluggableEngine.java](file://lealone-sci/src/main/java/com/lealone/db/plugin/PluggableEngine.java#L1-L46)
...
### 四、示例路径参考
- 自定义存储引擎实现：[AOStorageEngine.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/AOStorageEngine.java#L1-L32)
- 自定义事务引擎实现：[AOTransactionEngine.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransactionEngine.java#L1-L36)
- 自定义 SQL 引擎实现：[LealoneSQLEngine.java](file://lealone-sql/src/main/java/com/lealone/sql/LealoneSQLEngine.java#L1-L26)
- 协议服务器引擎基类：[ProtocolServerEngineBase.java](file://lealone-sci/src/main/java/com/lealone/server/ProtocolServerEngineBase.java#L1-L58)
- 插件对象与自动启动：[PluginObject.java](file://lealone-db/src/main/java/com/lealone/db/plugin/PluginObject.java#L1-L102)
