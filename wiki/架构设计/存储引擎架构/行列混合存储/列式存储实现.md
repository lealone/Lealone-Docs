...
- [Compressor.java](file://lealone-common/src/main/java/com/lealone/common/compress/Compressor.java)
...
- [BuiltInAggregate.java](file://lealone-sql/src/main/java/com/lealone/sql/expression/aggregate/BuiltInAggregate.java)
...
- [ColumnStorageLeafPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnStorageLeafPage.java#L1-L120)
- [ColumnsPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnsPage.java#L1-L63)
- [StorageDataType.java](file://lealone-sci/src/main/java/com/lealone/storage/type/StorageDataType.java#L1-L49)
- [RowType.java](file://lealone-db/src/main/java/com/lealone/db/row/RowType.java#L140-L171)
- [Compressor.java](file://lealone-common/src/main/java/com/lealone/common/compress/Compressor.java#L1-L66)
- [PageUtils.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/PageUtils.java#L1-L57)
...
- [ColumnsPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnsPage.java#L1-L63)
- [LeafPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/LeafPage.java#L1-L120)
- [Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L286-L378)
- [StorageDataType.java](file://lealone-sci/src/main/java/com/lealone/storage/type/StorageDataType.java#L1-L49)
- [RowType.java](file://lealone-db/src/main/java/com/lealone/db/row/RowType.java#L140-L171)
- [PageStorageMode.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/PageStorageMode.java#L1-L12)
...
图表来源
- [ColumnStorageLeafPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnStorageLeafPage.java#L68-L126)
- [ColumnPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnPage.java#L31-L92)
- [RowType.java](file://lealone-db/src/main/java/com/lealone/db/row/RowType.java#L154-L171)
- [Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L336-L378)
...
图表来源
- [ColumnPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnPage.java#L61-L92)
- [Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L308-L378)
...
- [StorageDataType.java](file://lealone-sci/src/main/java/com/lealone/storage/type/StorageDataType.java#L1-L49)
- [RowType.java](file://lealone-db/src/main/java/com/lealone/db/row/RowType.java#L140-L171)
- [TransactionalValueType.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/TransactionalValueType.java#L82-L158)
...
章节来源
- [BuiltInAggregate.java](file://lealone-sql/src/main/java/com/lealone/sql/expression/aggregate/BuiltInAggregate.java#L134-L209)
- [YieldableSelect.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableSelect.java#L1-L39)
- [Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L308-L378)
...
章节来源
- [Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L286-L378)
- [ColumnStorageLeafPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnStorageLeafPage.java#L192-L219)
- [ColumnPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnPage.java#L31-L92)
...
- 性能测试与对比方法
  ...
  - 示例测试文件：
    - [PageStorageModeTest.java](file://lealone-test/src/test/java/com/lealone/test/aose/PageStorageModeTest.java#L1-L42)
...
- 关键实现路径参考
  - 列页读取与延迟反序列化：[ColumnPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnPage.java#L31-L92)
  - 列式叶子页写入与列页定位：[ColumnStorageLeafPage.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/ColumnStorageLeafPage.java#L141-L191)
  - 压缩与解压工具：[Page.java](file://lealone-aose/src/main/java/com/lealone/storage/aose/btree/page/Page.java#L308-L378)
  - 列式序列化接口与实现：[StorageDataType.java](file://lealone-sci/src/main/java/com/lealone/storage/type/StorageDataType.java#L1-L49), [RowType.java](file://lealone-db/src/main/java/com/lealone/db/row/RowType.java#L140-L171)