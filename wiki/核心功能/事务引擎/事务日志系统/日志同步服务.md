...
- [FileDisk.java](https://github.com/lealone/Lealone/blob/master/lealone-common/src/main/java/com/lealone/storage/fs/impl/disk/FileDisk.java)
...
- [AOTransactionEngine.java](https://github.com/lealone/Lealone/blob/master/lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransactionEngine.java#L290-L311)
...
- [PendingTransaction.java](https://github.com/lealone/Lealone/blob/master/lealone-sci/src/main/java/com/lealone/transaction/PendingTransaction.java#L1-L51)
- [FileStorage.java](https://github.com/lealone/Lealone/blob/master/lealone-common/src/main/java/com/lealone/storage/fs/FileStorage.java#L441-L487)
- [FileDisk.java](https://github.com/lealone/Lealone/blob/master/lealone-common/src/main/java/com/lealone/storage/fs/impl/disk/FileDisk.java#L1-L43)
...
章节来源
- [LogSyncService.java](https://github.com/lealone/Lealone/blob/master/lealone-aote/src/main/java/com/lealone/transaction/aote/log/LogSyncService.java#L218-L320)
- [lealone-test.yaml](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/resources/lealone-test.yaml#L25-L33)
...
### 配置项与使用示例路径
- 基础配置示例（测试配置文件）
  - 位置：[lealone-test.yaml](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/resources/lealone-test.yaml#L25-L33)
  - 关键项：
