...
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java)
...
- [AsyncCallback.java](file://lealone-common/src/main/java/com/lealone/db/async/AsyncCallback.java)
...
- [TransferConnection.java](file://lealone-net/src/main/java/com/lealone/net/TransferConnection.java#L1-L153)
- [TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L1-L191)
- [AsyncConnectionPool.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionPool.java#L1-L94)
- [NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L1-L143)
- [NioEventLoop.java](file://lealone-net/src/main/java/com/lealone/net/nio/NioEventLoop.java#L527-L568)
- [BioWritableChannel.java](file://lealone-net/src/main/java/com/lealone/net/bio/BioWritableChannel.java#L125-L159)
- [AsyncServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServerConnection.java#L1-L28)
- [TcpServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/TcpServerConnection.java#L1-L249)
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L1-L169)
- [ConnectionSetting.java](file://lealone-common/src/main/java/com/lealone/db/ConnectionSetting.java#L1-L28)
- [AsyncCallback.java](file://lealone-common/src/main/java/com/lealone/db/async/AsyncCallback.java#L52-L100)
...
图表来源
- [NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L39-L51)
- [AsyncConnectionPool.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionPool.java#L28-L52)
- [TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L106-L145)
- [NioEventLoop.java](file://lealone-net/src/main/java/com/lealone/net/nio/NioEventLoop.java#L527-L568)
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L115-L134)
- [TcpServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/TcpServerConnection.java#L68-L96)
...
图表来源
- [NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L39-L51)
- [NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L66-L86)
...
章节来源
- [AsyncConnectionManager.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionManager.java#L1-L26)
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L115-L134)
...
章节来源
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L115-L134)
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L136-L148)
...
- [AsyncCallback.java](file://lealone-common/src/main/java/com/lealone/db/async/AsyncCallback.java#L52-L100)
- [NioEventLoop.java](file://lealone-net/src/main/java/com/lealone/net/nio/NioEventLoop.java#L527-L568)
- [TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L159-L168)
- [BioWritableChannel.java](file://lealone-net/src/main/java/com/lealone/net/bio/BioWritableChannel.java#L125-L159)
...
- [AsyncConnectionPool.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionPool.java#L28-L52)
- [TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L106-L145)
- [TcpServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/TcpServerConnection.java#L119-L141)
- [AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L115-L134)
...
- [ConnectionSetting.java](file://lealone-common/src/main/java/com/lealone/db/ConnectionSetting.java#L1-L28)
- [NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L131-L141)
- [AsyncConnectionPool.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionPool.java#L76-L80)
...
章节来源
- [NioEventLoop.java](file://lealone-net/src/main/java/com/lealone/net/nio/NioEventLoop.java#L527-L568)
- [TcpServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/TcpServerConnection.java#L177-L184)
- [TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L106-L145)
...
- 相关实现位置
  - 连接池与复用策略：[AsyncConnectionPool.java](file://lealone-net/src/main/java/com/lealone/net/AsyncConnectionPool.java#L28-L52)
  - 客户端生命周期管理：[NetClientBase.java](file://lealone-net/src/main/java/com/lealone/net/NetClientBase.java#L39-L51)
  - 服务器连接创建与注册：[AsyncServer.java](file://lealone-server/src/main/java/com/lealone/server/AsyncServer.java#L115-L134)
  - 服务器会话管理：[TcpServerConnection.java](file://lealone-server/src/main/java/com/lealone/server/TcpServerConnection.java#L68-L96)
  - 客户端异常与超时：[TcpClientConnection.java](file://lealone-net/src/main/java/com/lealone/net/TcpClientConnection.java#L159-L168), [AsyncCallback.java](file://lealone-common/src/main/java/com/lealone/db/async/AsyncCallback.java#L52-L100)
  - 事件循环异常处理：[NioEventLoop.java](file://lealone-net/src/main/java/com/lealone/net/nio/NioEventLoop.java#L527-L568)