...
- [YieldableQueryBase.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableQueryBase.java)
...
- [QOperator.java](file://lealone-sql/src/main/java/com/lealone/sql/query/QOperator.java)
- [Operator.java](file://lealone-sql/src/main/java/com/lealone/sql/operator/Operator.java)
...
- [YieldableQueryBase.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableQueryBase.java#L1-L25)
...
- [YieldableLocalUpdate.java](file://lealone-sql/src/main/java/com/lealone/sql/executor/YieldableLocalUpdate.java#L1-L32)
- [YieldableLoopUpdateBase.java](file://lealone-sql/src/main/java/com/lealone/sql/executor/YieldableLoopUpdateBase.java#L1-L88)
- [QOperator.java](file://lealone-sql/src/main/java/com/lealone/sql/query/QOperator.java#L1-L171)
- [Operator.java](file://lealone-sql/src/main/java/com/lealone/sql/operator/Operator.java#L1-L28)
- [Transaction.java](file://lealone-sci/src/main/java/com/lealone/transaction/Transaction.java#L1-L91)
- [TransactionEngine.java](file://lealone-sci/src/main/java/com/lealone/transaction/TransactionEngine.java#L1-L70)
- [AOTransaction.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransaction.java#L33-L401)
- [StorageEngine.java](file://lealone-sci/src/main/java/com/lealone/storage/StorageEngine.java#L1-L23)
- [StorageMap.java](file://lealone-sci/src/main/java/com/lealone/storage/StorageMap.java#L164-L228)
...
- [YieldableSelect.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableSelect.java#L73-L118)
- [QOperator.java](file://lealone-sql/src/main/java/com/lealone/sql/query/QOperator.java#L108-L132)
- [TransactionEngine.java](file://lealone-sci/src/main/java/com/lealone/transaction/TransactionEngine.java#L1-L70)
- [AOTransaction.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransaction.java#L33-L401)
- [StorageEngine.java](file://lealone-sci/src/main/java/com/lealone/storage/StorageEngine.java#L1-L23)
- [StorageMap.java](file://lealone-sci/src/main/java/com/lealone/storage/StorageMap.java#L164-L228)
...
图表来源
- [YieldableSelect.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableSelect.java#L36-L118)
- [YieldableSelect.java](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableSelect.java#L120-L212)
- [QOperator.java](file://lealone-sql/src/main/java/com/lealone/sql/query/QOperator.java#L108-L132)
...
章节来源
- [YieldableBase.java](file://lealone-sql/src/main/java/com/lealone/sql/executor/YieldableBase.java#L131-L159)
- [QOperator.java](file://lealone-sql/src/main/java/com/lealone/sql/query/QOperator.java#L154-L157)
- [AOTransaction.java](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransaction.java#L312-L359)
- [BatchStatementPacketHandlers.java](file://lealone-server/src/main/java/com/lealone/server/handler/BatchStatementPacketHandlers.java#L63-L89)
...
## 附录
- 关键路径参考
  - 可暂停执行：[YieldableBase.run](file://lealone-sql/src/main/java/com/lealone/sql/executor/YieldableBase.java#L93-L115)
  - 查询执行：[YieldableSelect.executeInternal](file://lealone-sql/src/main/java/com/lealone/sql/query/YieldableSelect.java#L90-L118)
  - 更新执行：[YieldableLoopUpdateBase.executeInternal](file://lealone-sql/src/main/java/com/lealone/sql/executor/YieldableLoopUpdateBase.java#L26-L37)
  - 事务提交：[AOTransaction.commitFinal](file://lealone-aote/src/main/java/com/lealone/transaction/aote/AOTransaction.java#L288-L301)
  - 存储映射：[StorageMap.cursor/save/close](file://lealone-sci/src/main/java/com/lealone/storage/StorageMap.java#L164-L228)