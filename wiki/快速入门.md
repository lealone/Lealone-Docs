...
- [Shell.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Shell.java)
- [LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java)
- [lealone-test.yaml](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/resources/lealone-test.yaml)
- [lealone.yaml](https://github.com/lealone/Lealone/blob/master/lealone-main/dist/conf/lealone.yaml)
...
图表来源
- [Shell.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Shell.java#L1-L34)
- [LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java#L1-L200)
- [Lealone.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Lealone.java#L1-L329)
- [lealone-test.yaml](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/resources/lealone-test.yaml#L1-L52)
- [lealone.yaml](https://github.com/lealone/Lealone/blob/master/lealone-main/dist/conf/lealone.yaml#L1-L40)
...
- [Shell.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Shell.java#L1-L34)
- [LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java#L1-L200)
- [EmbeddedExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/EmbeddedExample.java#L1-L36)
- [CRUDExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/CRUDExample.java#L1-L217)
...
图表来源
- [Lealone.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Lealone.java#L120-L207)
...
图表来源
- [Shell.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Shell.java#L1-L34)
- [Lealone.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Lealone.java#L67-L79)
...
图表来源
- [LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java#L110-L171)
...
图表来源
- [EmbeddedExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/EmbeddedExample.java#L1-L36)
- [CRUDExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/CRUDExample.java#L100-L121)
...
章节来源
- [Lealone.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Lealone.java#L100-L116)
- [lealone-test.yaml](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/resources/lealone-test.yaml#L1-L52)
...
### A. 从零开始的实践步骤（嵌入式模式）
- 步骤 1：运行嵌入式示例
  - 参考路径：[EmbeddedExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/EmbeddedExample.java#L1-L36)
- 步骤 2：执行 CRUD 操作
  - 参考路径：[CRUDExample.java](https://github.com/lealone/Lealone/blob/master/lealone-test/src/test/java/com/lealone/test/misc/CRUDExample.java#L100-L121)
- 步骤 3：查看交互式 Shell
  - 参考路径：[LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java#L110-L171)
...
- 步骤 1：启动 Lealone（非嵌入式）
  - 参考路径：[Lealone.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Lealone.java#L120-L207)
- 步骤 2：使用 Shell 连接
  - 参考路径：[Shell.java](https://github.com/lealone/Lealone/blob/master/lealone-main/src/main/java/com/lealone/main/Shell.java#L1-L34)
- 步骤 3：进入交互式 SQL
  - 参考路径：[LealoneClient.java](https://github.com/lealone/Lealone/blob/master/lealone-client/src/main/java/com/lealone/client/LealoneClient.java#L110-L171)
