...
下载脚手架 [create-lealone-app-5.1.2.jar](https://github.com/lealone/Lealone-Plugins/releases/download/lealone-plugins-5.1.2/create-lealone-app-5.1.2.jar)

然后在当前目录下创建一个 hello 应用：

`java -jar create-lealone-app-5.1.2.jar -groupId my.app.hello -artifactId hello`
