...
`java -jar lealone-5.2.0.jar -cluster -host 127.0.0.1`

`java -jar lealone-5.2.0.jar -cluster -host 127.0.0.2`

`java -jar lealone-5.2.0.jar -cluster -host 127.0.0.3`


### 1.4. 创建使用 Sharding 模式运行的数据库

打开一个新的命令行窗口，运行: `java -jar lealone-5.2.0.jar -client`
...
运行: `java -jar lealone-5.2.0.jar -client -database mydb_sharding`
...
`java -jar lealone-5.2.0.jar -cluster -host 192.168.0.101 -seeds 192.168.0.101`

`java -jar lealone-5.2.0.jar -cluster -host 192.168.0.102 -seeds 192.168.0.101`

`java -jar lealone-5.2.0.jar -cluster -host 192.168.0.103 -seeds 192.168.0.101`
