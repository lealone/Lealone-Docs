...
[lealone-polyglot-5.2.0.jar](https://github.com/lealone/Lealone-Docs/releases/download/lealone-docs-1.0.0/lealone-polyglot-5.2.0.jar)
...
打开一个新的命令行窗口，运行: `java -jar lealone-polyglot-5.2.0.jar`

```java
Lealone version: 5.2.0
Loading config from jar:file:/E:/lealone-polyglot-5.2.0/lealone-polyglot-5.2.0.jar!/lealone.yaml
...
打开一个新的命令行窗口，运行: `java -jar lealone-polyglot-5.2.0.jar -client`
